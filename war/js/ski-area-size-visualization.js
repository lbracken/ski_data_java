...
function requestAddSkiArea() {
	...
	if(skiAreaId) {
		$.getJSON("get_ski_areas_by_id", {id:skiAreaId, format:"long"}, addSkisAreas);          
		return;
	}
	...
	if(skiAreaName) {
		...
		$.getJSON("get_ski_areas_by_name", {name:skiAreaName, format:"long"}, addSkisAreas);
		return;
	}
...
function renderSkiAreaListItem(skiArea, ctr) {
	...
	var skiAreaListItemCloseImg = $("<img src='images/icons/close.png' title='Remove'/>");
	...
	skiAreaListItemCloseImg.hover(
			function(){skiAreaListItemCloseImg.attr("src", "images/icons/close_hover.png");},
			function(){skiAreaListItemCloseImg.attr("src", "images/icons/close.png");});
...
$(document).ready(function() {	
	...
	$.getJSON("get_ski_areas_by_id", {id:getStartupSkiIds(), format:"long"}, addSkisAreas);
